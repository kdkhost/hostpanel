...
return new class extends Migration
{
    ...
    {
        // Adiciona fee_amount e refunded_amount na tabela transactions (se já existir)
        ...
        // Adiciona whatsapp_enabled nos clients (se já existir)
        ...
        // Adiciona pass_fee, late_fee_enabled, interest_daily, late_fee_percent nos gateways (se já existir)
