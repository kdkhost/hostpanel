    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('plans') }}" class="text-gray-600 hover:text-gray-900 text-sm font-semibold">Ver todos os planos</a>
                <a href="{{ route('client.register') }}" class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-4 py-2 rounded-lg">Começar agora</a>
            </div>
        </div>
    </nav>
